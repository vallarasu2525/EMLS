...
if (isset($_POST['signin'])) {
    ...
    try {
        $sql = "SELECT EmailId, Password, Status, id FROM tblemployees WHERE EmailId = :uname LIMIT 1";
        ...
        echo "<script>console.log('Fetched Data: " . json_encode($result) . "');</script>";
                    ...
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                            ...
                            <div class="card-content ">
                                ...
                                <?php if (isset($msg)) { ?>
                                    <div class="errorWrap"><strong>Error</strong> : <?php echo $msg; ?> </div>
                                <?php } ?>
